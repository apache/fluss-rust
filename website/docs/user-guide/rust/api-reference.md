...
| `async fn unsubscribe_partition(&self, partition_id: i64, bucket_id: i32) -> Result<()>` | Unsubscribe from a partition bucket |
...
| `fluss::client::LATEST_OFFSET` | `-1` | Start reading from the latest offset (only new records) |
